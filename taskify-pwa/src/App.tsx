...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 p-4">
      ...
      <button
        className={`fixed ${settings.inlineAdd ? 'top-4' : 'bottom-4'} right-4 px-3 py-2 rounded-full bg-neutral-800 border border-neutral-700 shadow-lg text-sm transition-transform ${upcomingHover ? 'scale-110' : ''}`}
