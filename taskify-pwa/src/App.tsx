...
export default function App() {
  ...
  function toggleSubtask(taskId: string, subId: string) {
    ...
    setTasks(prev => prev.map(t => {
      ...
      updated = { ...t, subtasks: subs };
      return updated;
    }));
    if (updated) maybePublishTask(updated).catch(() => {});
  }
      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="flex items-center mb-2">
            ...
            <button
              type="button"
              className="ml-auto text-xs px-2 py-1 rounded bg-neutral-800"
              onClick={() => setSubtasks([...subtasks, { id: crypto.randomUUID(), title: "", completed: false }])}
            >
              Add
            </button>
          </div>
