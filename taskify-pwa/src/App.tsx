...
export default function App() {
  ...
  useEffect(() => {
    ...
    requestAnimationFrame(() => {
      ...
      if (!width) return;
      const targetCenter = ratio * width;
      const maxScroll = Math.max(0, width - scroller.clientWidth);
      const desiredLeft = targetCenter - scroller.clientWidth / 2;
        ...
        <div className="relative">
          {view === "board" || !settings.completedTab ? (
            !currentBoard ? (
              ...
              >
                <div className={`flex min-w-max ${boardZoomTargetClass}`}>
        ...
        <button
          ...
          onClick={() => {
            ...
            if (scroller && scroller.scrollWidth > 0) {
              ...
              const ratio = center / scroller.scrollWidth;
