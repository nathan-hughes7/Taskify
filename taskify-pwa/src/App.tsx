          ...
          <div className="flex items-center gap-3 w-full overflow-x-auto overflow-y-visible">
            ...
            <div className="ml-auto flex items-center gap-2 flex-shrink-0">
              ...
              {settings.completedTab ? (
                <button
                  ref={completedTabRef}
                  className={`flex items-center justify-center px-3 py-2 rounded-xl border transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500 ${
                    view === "completed"
